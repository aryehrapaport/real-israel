  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <div className="relative overflow-hidden rounded-2xl border border-border/70 bg-card/60 p-6 sm:p-8">
        <div className="pointer-events-none absolute inset-0 opacity-100 [background-image:radial-gradient(800px_circle_at_15%_20%,hsl(var(--primary)/0.16),transparent_55%)]" />
